...
export const readFile = tool({
	description:
		"Read the full contents of a file at the specified path. Always use this to read a file and its contents.",
	inputSchema: z.object({
		path: z
			.string()
			.describe("The relative or absolute path to the file to read"),
	}),
